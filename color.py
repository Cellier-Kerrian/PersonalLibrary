...
liste_color = ['black', 'k', 'dimgrey', 'dimgray', 'grey', 'gray', 'darkgrey',
               'darkgray', 'silver', 'lightgrey', 'lightgray', 'gainsboro', 
               'whitesmoke', 'white', 'w', 'snow', 'rosybrown', 'lightcoral', 
               'indianred', 'brown', 'firebrick', 'maroon', 'darkred', 'red', 
               'r', 'mistyrose', 'salmon', 'tomato', 'darksalmon', 'coral', 
               ...
               'lightgoldenrodyellow', 'olive', 'y', 'yellow', 'olivedrab', 
               ...
               'g', 'lime', 'seagreen', 'mediumseagreen', 'springgreen', 
               ...
               'darkslategrey', 'teal', 'darkcyan', 'c', 'cyan', 'aqua', 
               'darktuquoise', 'cadetblue', 'powderblue', 'lightblue', 
               'deepskyblue', 'skyblue', 'lightskyblue', 'steelblue', 'aliceblue', 'dodgerblue', 
               'lightslategrey', 'lightslategray', 'slategrey', 'slategray', 
               'lightsteelblue', 'cornflowerblue', 'royalblue', 'ghostwhite', 
               'lavender', 'midnightblue', 'navy', 'darkblue', 'mediumblue', 'blue', 'b', 
               'slateblue', 'darkslateblue', 'mediumslateblue', 'mediumpurple', 
               'rebeccapurple', 'blueviolet', 'indigo', 'darkorchid', 
               'darkviolet', 'mediummorchid', 'thistle', 'plum', 'violet', 
               'purple', 'darkmagenta', 'm', 'magenta', 'fuchsia', 'orchid', 
...
def verif_color(color):
    ...
    -------
    str
        the color in hexadecimal code.
        
    Description
    -------
        have the color in hexadecimal.
        
    '''
    
    return dico_color[color]